...
export function PointsBalance({ points, tier }: PointsBalanceProps) {
  ...
  const getTierProgress = () => {
    const tiers = {
      silver: { min: 0, max: 10000, next: 'Gold' },
      gold: { min: 10000, max: 25000, next: 'Platinum' },
      platinum: { min: 25000, max: 50000, next: 'Diamond' },
    };
  ...
  return (
    ...
    >
      <Card className="shadow-lg bg-gradient-to-br from-green-600 to-green-500 text-white overflow-hidden relative h-full">
        ...
        <CardContent className="relative z-10 space-y-6">
          <div className="text-center py-4">
            ...
            <p className="text-green-100 text-lg">Available Points</p>
          </div>
